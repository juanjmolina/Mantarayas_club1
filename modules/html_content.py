...
/* modal */
.overlay{ position:fixed; inset:0; background:rgba(6,12,18,.5); backdrop-filter:blur(2px); display:none; align-items:center; justify-content:center; z-index:100; padding:20px; overflow-y:auto; }
.overlay.active{ display:flex; }
.modal{ background:var(--surface); border-radius:16px; width:100%; max-width:640px; max-height:88%; display:flex; flex-direction:column; box-shadow:var(--shadow-lg); animation:pop .18s ease; margin:auto; }
...
@media (max-width:860px){
  ...
  .modal{ max-height:92%; border-radius:16px 16px 0 0; margin:auto 0 0; }
  .drawer{ width:100%; }
  .toolbar{ gap:6px; }
...
/* ---------- login ---------- */
/* Ojo: NO usar min-height:100vh aquí. El panel vive en un iframe cuyo alto
   Streamlit ajusta dinámicamente al contenido (ver _scstReportHeight). Si
   este contenedor pidiera 100vh, el alto pedido dependería del alto actual
   del iframe (que puede venir grande, de la vista anterior) y nunca se
   encogería — dejando la tarjeta de login centrada muy abajo en la página.
   Sin min-height, el contenedor mide solo lo que ocupa la tarjeta y el
   iframe se ajusta a eso, así el login queda arriba, visible de una vez. */
.login-wrap{ display:flex; align-items:center; justify-content:center; background:
  radial-gradient(circle at 15% 20%, var(--primary-soft), transparent 45%),
  radial-gradient(circle at 85% 80%, var(--primary-soft), transparent 40%), var(--bg); padding:40px 20px; }
  ...
  <aside class="sidebar" id="sidebar">
    <div class="brand">
      <div class="brand-mark">
        <img src="data:image/png;base64," alt="Mantarayas" style="width:100%;height:100%;object-fit:contain;padding:5px;position:relative;z-index:1;">
      </div>
      <div>
...
function setView(id){
  ...
  if(typeof _scstReportHeight === 'function') setTimeout(_scstReportHeight, 50);
}
...
function viewDashboard(el){
  ...
  if(!state._dashboardMes) state._dashboardMes = monthKey();
  const mk = state._dashboardMes;
  ...
  el.innerHTML = `
    <div class="view-header">
      <div><h1 class="view-title">Hola, bienvenido de nuevo 👋</h1><p class="view-desc">Así va el club ${mk===monthKey()?'hoy, '+new Date().toLocaleDateString('es-CO',{weekday:'long', day:'numeric', month:'long'}):'en '+monthLabel(mk)}.</p></div>
      <div style="display:flex;gap:8px;align-items:center;">
        ${monthYearPickerHTML('dashMes', mk)}
  ...
  `;
  bindMonthYearPicker('dashMes', ()=>{ state._dashboardMes = readMonthYearPicker('dashMes'); renderCurrentView(); });
}
...
function viewAlumnos(el){
  ...
  if(!state._alumMes) state._alumMes = monthKey();
  const mk = state._alumMes;
  ...
  el.innerHTML = `
    ...
    <div class="toolbar">
      ...
      <span class="cell-sub" style="margin-left:4px;">Pago de:</span>
      ${monthYearPickerHTML('alumMes', mk)}
    ...
    <div class="card">
      <div class="table-wrap">
        ...
        <tbody>${list.length? list.map(s=>rowAlumno(s, mk)).join('') : '<tr><td colspan="6"><div class="empty">Sin resultados para este filtro.</div></td></tr>'}</tbody></table>
      </div>
    </div>
  `;
  bindMonthYearPicker('alumMes', ()=>{ state._alumMes = readMonthYearPicker('alumMes'); viewAlumnos(el); });
...
function renderDrawerBody(){
  ...
  if(state.drawerTab==='datos'){
    ...
    body.innerHTML = `
      ...
      ${recs.length? recs.map(r=>`<div class="kv" style="align-items:center;"><span>${monthLabel(r.mes)} · ${{mensualidad:'Mensualidad',matricula:'Matrícula',abono:'Abono',cortesia:'Cortesía',beca:'Beca'}[r.tipo]||r.tipo}</span><span style="display:flex;align-items:center;gap:8px;">${fmtMoney(r.monto)}<button class="btn btn-sm btn-ghost" style="padding:4px 8px;" title="Editar pago" data-action="edit-payment" data-id="${r.id}"><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg></button><button class="btn btn-sm btn-ghost" style="padding:4px 8px;" title="Descargar factura" data-action="download-invoice" data-id="${r.id}"><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3v13m0 0-4-4m4 4 4-4M4 20h16"/></svg></button></span></div>`).join('') : '<div class="empty" style="padding:20px;">Sin pagos registrados</div>'}
    `;
...
function rowPago(s, mk){
  ...
  return `<tr data-action="open-student" data-id="${s.id}">
    ...
    <td style="display:flex;gap:6px;">
      <button class="btn btn-sm" data-action="open-add-payment" data-id="${s.id}">Registrar pago</button>
      ${rec?`<button class="btn btn-sm btn-ghost" title="Editar este pago" data-action="edit-payment" data-id="${rec.id}"><svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg></button>`:''}
    </td>
  </tr>`;
}

function openPaymentModal(studentId, defaultMes, paymentId){
  const editing = paymentId ? state.payments.find(x=>x.id===paymentId) : null;
  const s = state.students.find(x=>x.id===(editing ? editing.studentId : studentId));
  if(!s) return;
  const mk = editing ? editing.mes : (defaultMes || state._pagosMes || monthKey());
  const metodos = ['Transferencia','Efectivo','Tarjeta','Nequi/Daviplata'];
  const html = `
    <div class="modal-head"><h3>${editing?'Editar pago':'Registrar pago'} — ${escapeHtml(s.nombre)}</h3><button class="icon-btn" data-action="close-modal"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 6 6 18M6 6l12 12"/></svg></button></div>
    <div class="modal-body">
      <form id="paymentForm">
        <div class="field-row">
          <div class="field"><label>Tipo de pago</label><select name="tipo" id="paymentTipo">
            <option value="mensualidad" ${editing&&editing.tipo==='mensualidad'?'selected':''}>Mensualidad</option>
            <option value="matricula" ${editing&&editing.tipo==='matricula'?'selected':''}>Matrícula</option>
            <option value="abono" ${editing&&editing.tipo==='abono'?'selected':''}>Abono</option>
            <option value="beca" ${editing&&editing.tipo==='beca'?'selected':''}>Beca (100%)</option>
            <option value="cortesia" ${editing&&editing.tipo==='cortesia'?'selected':''}>Cortesía</option>
          </select></div>
          <div class="field"><label>Mes que cubre</label><div style="display:flex;gap:6px;">${monthYearPickerHTML('paymentMes', mk)}</div></div>
        </div>
        <div class="field-row">
          <div class="field"><label>Valor</label><input type="number" name="monto" id="paymentMonto" value="${editing?editing.monto:120000}" min="0" step="1000"></div>
          <div class="field"><label>Método de pago</label><select name="metodo">${metodos.map(m=>`<option ${editing&&editing.metodo===m?'selected':''}>${m}</option>`).join('')}</select></div>
        </div>
        <div class="field"><label>Fecha</label><input type="date" name="fecha" value="${editing?editing.fecha:todayISO()}"></div>
        <div class="field"><label>Nota / comprobante</label><textarea name="nota" rows="2" placeholder="Número de comprobante o nota interna">${editing?escapeHtml(editing.nota||''):''}</textarea></div>
      </form>
    </div>
    <div class="modal-foot">
      ${editing && state.role==='super' ? `<button class="btn btn-danger" data-action="delete-payment" data-id="${editing.id}" style="margin-right:auto;">Eliminar</button>` : ''}
      <button class="btn" data-action="close-modal">Cancelar</button>
      <button class="btn btn-primary" data-action="save-payment" data-id="${s.id}" data-payment-id="${editing?editing.id:''}">${editing?'Guardar cambios':'Guardar pago'}</button>
    </div>
  `;
  openModal(html);
...
async function savePaymentFromForm(studentId, paymentId){
  ...
  const datos = { tipo:fd.get('tipo'), mes, monto, metodo:fd.get('metodo'), fecha:fd.get('fecha')||todayISO(), nota:fd.get('nota')||'' };
  if(paymentId){
    const idx = state.payments.findIndex(x=>x.id===paymentId);
    if(idx===-1){ toast('No se encontró el pago', 'danger'); return; }
    state.payments[idx] = Object.assign({}, state.payments[idx], datos);
    const ok = await saveKey('mantarayas:payments', state.payments);
    if(ok){
      toast('Pago actualizado');
      closeModal(); renderCurrentView();
      if(state.drawerStudentId===studentId) renderDrawerBody();
    }
    return;
  }
  const rec = Object.assign({id:uid('pg'), studentId}, datos);
  ...
  if(ok){
    ...
    closeModal(); renderCurrentView();
    if(state.drawerStudentId===studentId) renderDrawerBody();
    setTimeout(()=>generarFacturaPDF(rec.id), 300);
  }
}
async function deletePayment(id){
  if(!confirm('¿Eliminar este pago? Esta acción no se puede deshacer.')) return;
  const rec = state.payments.find(p=>p.id===id);
  state.payments = state.payments.filter(p=>p.id!==id);
  const ok = await saveKey('mantarayas:payments', state.payments);
  if(ok){
    toast('Pago eliminado');
    closeModal(); renderCurrentView();
    if(rec && state.drawerStudentId===rec.studentId) renderDrawerBody();
  }
}
...
/* El panel vive dentro de un iframe de Streamlit cuyo alto se ajusta para
   igualar el alto de TODO el contenido (así nunca se corta nada). Eso
   significa que el iframe casi nunca tiene scroll propio: quien scrollea
   es la página de afuera (window.parent). Un overlay "position:fixed" de
   toda la vida se posiciona en base al alto del iframe (que puede ser
   enorme si hay una lista larga), no en base a lo que el usuario está
   viendo — por eso el formulario podía aparecer "súper abajo". Estas dos
   funciones anclan el overlay a la porción realmente visible de la
   página (usando el scroll y alto de la ventana de afuera, a la que
   podemos acceder porque el componente se sirve desde el mismo origen). */
function _mantarayasVisibleViewport(){
  try{
    if(window.parent && window.parent!==window){
      return { top: window.parent.scrollY||0, height: window.parent.innerHeight||window.innerHeight||600 };
    }
  }catch(e){}
  return { top: window.scrollY||0, height: window.innerHeight||600 };
}
function _mantarayasPinToViewport(el){
  if(!el) return;
  const v = _mantarayasVisibleViewport();
...
function openModal(html){
  ...
  _mantarayasPinToViewport(overlay);
}
function closeModal(){
  const overlay = document.getElementById('modalOverlay');
...
function bindGlobalActions(){
  document.body.addEventListener('click', async (e)=>{
    ...
    switch(action){
      ...
      case 'edit-payment': openPaymentModal(null, null, id); break;
      case 'save-payment': savePaymentFromForm(id, target.dataset.paymentId || null); break;
      ...
      case 'download-invoice': generarFacturaPDF(id); break;
    ...
    <div class="login-wrap">
      <div class="login-card">
        <div class="login-logo">
          <div class="login-mark"><img src="data:image/png;base64," alt="Mantarayas" style="width:100%;height:100%;object-fit:contain;padding:8px;"></div>
...
function _scstReady(){
  ...
  if(window.ResizeObserver){
    const ro = new ResizeObserver(function(){ _scstReportHeight(); });
    ro.observe(document.body);
    ro.observe(document.documentElement);
    const appRootEl = document.getElementById('appRoot');
    if(appRootEl) ro.observe(appRootEl);
  } else {
...
let _mantarayasPendingOwnSave = false;
window.addEventListener('message', function(event){
  const d = event.data;
  if(!d || d.type !== 'streamlit:render') return;
  const args = d.args || {};
  if(_mantarayasPendingOwnSave){
    // Esto es la confirmación de un guardado que ACABAMOS de mandar nosotros
    // mismos — nunca lo volvemos a aplicar (evita el bug de "hay que
    // guardar dos veces": un eco que llega tarde no debe pisar un cambio
    // más reciente que el usuario ya hizo en pantalla).
    _mantarayasPendingOwnSave = false;
    const statusEl = document.getElementById('dbSyncStatus');
    if(statusEl) statusEl.textContent = 'Sincronizado con la base de datos';
    _mantarayasLastAppliedHash = args.hash_db || _mantarayasLastAppliedHash;
  } else if(args.datos_db && args.hash_db && args.hash_db !== _mantarayasLastAppliedHash){
    // Esto llegó por un sondeo periódico (ver _mantarayasPollLoop más abajo),
    // no por algo que enviamos nosotros — y trae datos distintos a los que
    // tenemos aplicados. Es un cambio hecho desde OTRO dispositivo: lo
    // aplicamos para que todos vean lo mismo sin tener que recargar la página.
    applySnapshotFromDB(args.datos_db, args.hash_db);
  }
});

/* Cada pocos segundos le preguntamos al servidor si hay algo más nuevo que
   lo que tenemos — así los cambios hechos desde otro dispositivo llegan
   solos, sin que nadie tenga que recargar la página. */
function _mantarayasPollLoop(){
  if(_mantarayasComponentReady && !document.hidden){
    _scstSend('streamlit:setComponentValue', {value: {__poll__:true, t:Date.now()}, dataType:'json'});
  }
  setTimeout(_mantarayasPollLoop, 15000);
}
setTimeout(_mantarayasPollLoop, 15000);
...
/* ============ FACTURA EN PDF ============ */
const CLUB_DATOS = {
  razonSocial: 'Club Deportivo Mantarayas',
  nit: '1007362144',
  logoB64: '',
};
const TIPO_PAGO_LABEL = {
  mensualidad:'Mensualidad', matricula:'Matrícula', abono:'Abono', beca:'Beca', cortesia:'Cortesía',
};

function generarFacturaPDF(paymentId){
  const p = state.payments.find(x=>x.id===paymentId);
  if(!p){ toast('No se encontró el pago', 'danger'); return; }
  const s = state.students.find(x=>x.id===p.studentId);
  if(!window.jspdf || !window.jspdf.jsPDF){ toast('No se pudo cargar el generador de PDF. Verifica tu conexión.', 'danger'); return; }
  ...
  // ---- Encabezado con logo ----
  try{ doc.addImage('data:image/jpeg;base64,'+CLUB_DATOS.logoB64, 'JPEG', marginX, y-6, 26, 15.3); }catch(e){}
  doc.setFont('helvetica','bold'); doc.setFontSize(13);
  doc.text(CLUB_DATOS.razonSocial, marginX+32, y);
  doc.setFont('helvetica','normal'); doc.setFontSize(9.5); doc.setTextColor(90);
  doc.text('Nit: '+CLUB_DATOS.nit, marginX+32, y+5.5);
  doc.setTextColor(20);

  doc.setFont('helvetica','bold'); doc.setFontSize(14);
  doc.text('COMPROBANTE DE PAGO', pageW-marginX, y, {align:'right'});
  doc.setFont('helvetica','normal'); doc.setFontSize(9.5); doc.setTextColor(90);
  doc.text('No. '+p.id.toUpperCase(), pageW-marginX, y+5.5, {align:'right'});
  doc.setTextColor(20);
  ...
  function fila(label, value){
    ...
    doc.text(String(value||'—'), marginX, y+5.5);
    y += 13;
  }
  function filaDoble(label1, value1, label2, value2){
    const half = (pageW-marginX*2)/2;
    doc.setFont('helvetica','bold'); doc.setFontSize(9.5); doc.setTextColor(110);
    doc.text(label1, marginX, y); doc.text(label2, marginX+half, y);
    doc.setFont('helvetica','normal'); doc.setFontSize(11); doc.setTextColor(20);
    doc.text(String(value1||'—'), marginX, y+5.5); doc.text(String(value2||'—'), marginX+half, y+5.5);
    y += 13;
  }

  doc.setFont('helvetica','bold'); doc.setFontSize(10.5); doc.setTextColor(20);
  doc.text('Datos del deportista', marginX, y); y += 8;
  filaDoble('Nombre', s ? s.nombre : 'Alumno no encontrado', 'Documento', s ? (s.documento||'—') : '—');
  filaDoble('Grupo / horario', s ? groupOfStudent(s).map(g=>g.dia+' '+g.hora).join(', ')||'—' : '—', 'Acudiente', s ? (s.acudiente||'—') : '—');
  ...
  doc.setFont('helvetica','bold'); doc.setFontSize(10.5); doc.setTextColor(20);
  doc.text('Datos del pago', marginX, y); y += 8;
  filaDoble('Concepto', TIPO_PAGO_LABEL[p.tipo]||p.tipo, 'Mes que cubre', monthLabel(p.mes));
  filaDoble('Fecha de pago', fmtDate(p.fecha), 'Método de pago', p.metodo||'—');
  if(p.nota) fila('Nota', p.nota);
  ...
  doc.roundedRect(marginX, y-8, pageW-marginX*2, 16, 2, 2, 'F');
  doc.setFont('helvetica','bold'); doc.setFontSize(11); doc.setTextColor(20);
  doc.text('Valor pagado', marginX+6, y+1.5);
  doc.setFontSize(15);
  doc.text(fmtMoney(p.monto), pageW-marginX-6, y+1.5, {align:'right'});

  y += 24;
  doc.setFont('helvetica','normal'); doc.setFontSize(8.5); doc.setTextColor(140);
  doc.text('Generado desde el panel administrativo de '+CLUB_DATOS.razonSocial+' · '+new Date().toLocaleDateString('es-CO'), marginX, y);

  const nombreArchivo = 'comprobante_'+(s?s.nombre.replace(/\s+/g,'_'):'pago')+'_'+p.mes+'.pdf';
