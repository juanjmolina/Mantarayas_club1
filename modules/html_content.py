...
function rowPago(s, mk){
  ...
  return `<tr data-action="open-student" data-id="${s.id}">
    ...
    <td><button class="btn btn-sm" data-action="open-add-payment" data-id="${s.id}">Registrar pago</button></td>
  </tr>`;
}
